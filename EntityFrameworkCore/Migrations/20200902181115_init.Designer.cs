            ...
            modelBuilder.Entity("Domain.Entities.ProductType", b =>
                {
                    ...
                    b.HasIndex("LicenceTypeId")
                        .IsUnique()
                        .HasFilter("[LicenceTypeId] IS NOT NULL");

                    b.HasIndex("PlatformId")
                        .IsUnique()
                        .HasFilter("[PlatformId] IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Entities.ProductType", b =>
                {
                    b.HasOne("Domain.Constants.Brand", "Brand")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.ProductType", "BrandId")
                    ...
                    b.HasOne("Domain.Constants.LicenceType", "LicenceType")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.ProductType", "LicenceTypeId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Domain.Constants.Platform", "Platform")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.ProductType", "PlatformId")
                        .OnDelete(DeleteBehavior.SetNull);
